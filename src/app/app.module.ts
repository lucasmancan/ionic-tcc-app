...
@NgModule({
  ...
  entryComponents: [],
  imports: [BrowserModule, IonicModule.forRoot(), AppRoutingModule, OptionsPageModule, SearchFilterPageModule, HttpClientModule],
  providers: [
    StatusBar,
    SplashScreen, SalesService, AuthService,
